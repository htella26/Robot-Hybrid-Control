...
% Define the DH parameters with proper number of inputs
...
% Define viscous friction (motor referenced)
L{1}.B = 1.48e-3;
L{2}.B = .817e-3;
L{3}.B = 1.38e-3;
L{4}.B = 71.2e-6;
...
% Define Coulomb friction (motor referenced)
L{1}.Tc = [.395 -.435];
L{2}.Tc = [.126 -.071];
L{3}.Tc = [.132 -.105];
...
% Clear the variable L after creating the robot model
clear L

% Assign name and manufacturer
p560.name = 'Puma 560';
